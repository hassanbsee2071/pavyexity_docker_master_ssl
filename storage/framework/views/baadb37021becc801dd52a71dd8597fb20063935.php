...
<?php endif; ?>
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div id="op3"  style="display: none" class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <select id="account_type"  class="form-control col-md-7 col-xs-12 <?php if($errors->has('payment_method')): ?> parsley-error <?php endif; ?>" name="account_type">
            ...
            <!-- <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="account_type"  type="text" class="form-control col-md-7 col-xs-12 <?php if($errors->has('account_type')): ?> parsley-error <?php endif; ?>" name="account_type" value="" placeholder="Enter Account Type">
            </div> -->
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="payment_amount" type="payment_amount" class="form-control col-md-7 col-xs-12 <?php if($errors->has('payment_amount')): ?> parsley-error <?php endif; ?>"  value="<?php echo e($Transactions->transaction_amount); ?>"  name="payment_amount" placeholder="0.00" disabled />
        ...
        <?php echo e(Form::hidden('payment_amount', $Transactions->transaction_amount)); ?>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\dev_repos\payvexity\resources\views/admin/payments/receivepayment.blade.php ENDPATH**/ ?>