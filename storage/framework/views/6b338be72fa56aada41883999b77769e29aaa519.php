    ...
    <div class="col-md-8 col-sm-12 col-xs-12 col-md-offset-2 card" style="padding-top: 12px;">
        ...
        <div class="form-group">
            ...
            <div class="col-md-1 col-sm-3 col-lg-1 col-xs-12">
                <input id="is_enable" type="checkbox" class="form-control <?php if($errors->has('is_enable')): ?> parsley-error <?php endif; ?>" name="is_enable" checked >
            </div>
            <label class="control-label col-md-2 col-lg-2 col-sm-3 col-xs-12" for="guest" >
                Enable Guest
            </label>
            <div class="col-md-1 col-sm-6 col-lg-1 col-xs-12">
                <input id="is_guest" type="checkbox" class="form-control" name="is_guest" checked >
            </div>
            <label class="control-label col-md-2 col-lg-2 col-sm-3 col-xs-12" for="is_fixed" >
                Fixed Amount
            </label>
            <div class="col-md-1 col-sm-6 col-lg-1 col-xs-12">
                <input id="is_fixed" type="checkbox" class="form-control" name="is_fixed" checked >
            </div>
        </div>
        <br><br>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\dev_repos\payvexity\resources\views/admin/payments/online/create-link.blade.php ENDPATH**/ ?>