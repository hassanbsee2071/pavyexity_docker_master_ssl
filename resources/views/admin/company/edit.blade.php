...
<div class="row">
    <div class="col-md-8 col-sm-12 col-xs-12 col-md-offset-2 card" style="padding-top: 12px;">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="is_bank_allowed" type="checkbox" class="form-control col-md-7 col-xs-12 @if($errors->has('is_bank_allowed')) parsley-error @endif" name="is_bank_allowed"  @if($company->is_bank_allowed == 'on') checked @endif>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="is_credit_allowed" type="checkbox" class="form-control col-md-7 col-xs-12 @if($errors->has('is_credit_allowed')) parsley-error @endif" name="is_credit_allowed" @if($company->is_credit_allowed == 'on') checked @endif  >
