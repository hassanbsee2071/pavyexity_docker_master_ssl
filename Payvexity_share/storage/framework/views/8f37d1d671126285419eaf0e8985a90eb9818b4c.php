...
<?php if(Session::has('errorMessage')): ?>
    ...
    <div class="App-Container is-noBackground flex-container justify-content-center">
        <div class="App App--singleItem" style="padding-top: 30px;">
    ...
    <div style="display:none" id="bank_account" class="App-Global-Fields flex-container spacing-16 direction-row wrap-wrap">
                                    ...
                                    <div class="FormFieldGroup-Fieldset" id="email-fieldset">
                                        <div class="FormFieldGroup-container">
                                            <div
                                                ...
                                                <div class="FormFieldInput"><span class="InputContainer"
                                                        data-max=""><input class="CheckoutInput Input Input--empty"
                                                            autocomplete="bank name" autocorrect="off"
                                                            spellcheck="false" id="bankName" name="name"
                                                            type="text" aria-label="bankName" placeholder="Enter name"
                                                            aria-invalid="false" aria-describedby="" value="" required></span></div>
                                            </div>
                                            <div
                                                class="FormFieldGroup-child FormFieldGroup-child--width-12 FormFieldGroup-childLeft FormFieldGroup-childRight FormFieldGroup-childTop FormFieldGroup-childBottom">
                                                <div class="FormFieldInput"><span class="InputContainer"
                                                        data-max=""><input class="CheckoutInput Input Input--empty"
                                                            autocomplete="email name" autocorrect="off"
                                                            spellcheck="false" id="shippingName" name="email"
                                                            type="email" aria-label="Name" placeholder="Enter email"
                                                            aria-invalid="false" aria-describedby="" value="" required></span></div>
                                            </div>
                                            <div
                                                class="FormFieldGroup-child FormFieldGroup-child--width-12 FormFieldGroup-childLeft FormFieldGroup-childRight FormFieldGroup-childTop FormFieldGroup-childBottom">
                                                <div class="FormFieldInput"><span class="InputContainer"
                                                        ...
                                                        id="account_number" onkeyup="account(this)" type="text" required></span></div>
                                            </div>
                                            <div style="opacity: 0; height: 0px;"><span
                                                ...
                                                class="FormFieldGroup-child FormFieldGroup-child--width-12 FormFieldGroup-childLeft FormFieldGroup-childRight FormFieldGroup-childTop FormFieldGroup-childBottom">
                                                <div class="FormFieldInput"><span class="InputContainer"
                                                        data-max=""><input class="CheckoutInput Input Input--empty <?php if($errors->has('routing_number')): ?> parsley-error <?php endif; ?>" id="routing_number" onkeyup="routing(this)" type="number" name="routing_number" placeholder="Enter bank routing number" required></span></div>
                                            </div>
                                            <div
                                                class="FormFieldGroup-child FormFieldGroup-child--width-12 FormFieldGroup-childLeft FormFieldGroup-childRight FormFieldGroup-childTop FormFieldGroup-childBottom">
                                                <div class="FormFieldInput is-select"><span class="InputContainer"
                                                        data-max="">
                                                        <div class="Select">
                                                        <select id="account_type" class="form-control col-md-7 col-xs-12 <?php if($errors->has('account_type')): ?> parsley-error <?php endif; ?>" name="account_type" required>
                                                ...
                                                <div class="FormFieldInput"><span class="InputContainer"
                                                        data-max=""><input class="CheckoutInput Input Input--empty"
                                                            autocomplete="bank name" autocorrect="off"
                                                            spellcheck="false" id="bankName" name="bank_account_name"
                                                            type="text" aria-label="Name" placeholder="Enter bank name"
                                                            aria-invalid="false" aria-describedby="" value="" required></span></div>
                                            </div>
                                            </div>
                                        <div style="opacity: 0; height: 0px;"><span
                        ...
                        <div style="opacity: 0; height: 0px;position:fixed; top: -1000px" id="credit_card" class="PaymentForm-paymentMethodFormContainer flex-container spacing-16 direction-row wrap-wrap">
                            <div class="flex-item width-12">
                                <div class="FormFieldGroup">
                                    <div
                                            ...
                                            <div
                                                ...
                                                <div class="FormFieldInput"><span class="InputContainer"
                                                        data-max=""><input class="CheckoutInput Input Input--empty"
                                                            ...
                                                            type="text" aria-label="Name" placeholder="Enter name"
                                                            aria-invalid="false" aria-describedby="" value="" required></span></div>
                                            </div>
                                            <div style="opacity: 0; height: 0px;"><span
                                                    class="FieldError Text Text-color--red Text-fontSize--13"><span
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auth.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/admin/payments/receivepayment-unreg.blade.php ENDPATH**/ ?>