    ...
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="site_title">
                <img src="<?php echo e(asset('/public/images/logo.png')); ?>" alt="Logo" title="Logo" class="img-fluid" />
            </a>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li class=""><a><i class="fa fa-cogs"></i> Online Payment Service <span class="fa fa-chevron-down"></span></a>
                ...
                <ul class="nav side-menu">
                    ...
                    <li class=""><a><i class="fa fa-cogs"></i> Settings <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none;">
                            ...
                            <?php if(isAdmin()): ?>
                            <li class="current-page">
                                <a href="<?php echo e(route('admin.company.edit', ['id' => Session::get('admin_company_id')])); ?>"><i class="fa fa-users" aria-hidden="true"></i>Edit Company</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </li>
...
<?php /**PATH E:\dev_repos\payvexity\resources\views/admin/sections/navigation.blade.php ENDPATH**/ ?>